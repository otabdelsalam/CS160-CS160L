...
import edu.sdsu.cs160l.university.course.CS150;
...
public class SinglyLinkedList {
    ...
    public static void main(String[] args)
    {
        ...
        list2 = insert(list2, "CS150");
        list2 = insert(list2, "CS160");
        list2 = insert(list2, "CS210");
        list2 = deleteByKey(list2, "CS150");
        list2 = deleteByKey(list2, "CS160");
        list2 = insert(list2, "CS150L");
        list2 = insert(list2, "CS160L");
        printList(list2);
